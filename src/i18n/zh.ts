...
export const messages: Record<string, string> = {
  ...
  'ai.dir_links.intro': '- 本 bot 的卡片页脚会显示当前分支的 {targets} 链接。{steps}命令要在实际改代码的仓库目录（如你新建的 worktree）里执行，页脚会随之显示该目录的仓库和分支；只写已确认的真实链接，不要猜；链接变了就重新 set；不要手改 .botmux-dir.json。',
  'ai.dir_links.mr': '创建或找到本任务的 MR 后执行 `botmux dir set mr <MR 地址>`；',
