...
export const messages: Record<string, string> = {
  ...
  'ai.dir_links.use': '- This bot\'s card footer shows the repo and branch you are changing. When you start working in a repo directory (e.g. a new worktree), run `botmux dir use` inside it first — otherwise the footer shows the session working directory\'s branch. ',
  'ai.dir_links.intro': 'The footer also shows the current branch\'s {targets} link: {steps}Run these inside that repo directory too. Only record links you have confirmed — never guess; re-run set when a link changes; do not hand-edit .botmux-dir.json.',
  'ai.dir_links.mr': 'After creating or finding this task\'s MR, run `botmux dir set mr MR_URL`. ',
  'ai.dir_links.meego': 'Once the Meego work item for this task is known, run `botmux dir set meego WORK_ITEM_URL`. ',
