...
export const messages: Record<string, string> = {
  ...
  'ai.dir_links.intro': '- This bot\'s card footer shows the current branch\'s {targets} link. {steps}Run it inside the repo directory you are actually changing (e.g. the worktree you created) — the footer then shows that directory\'s repo and branch. Only record links you have confirmed — never guess; re-run set when a link changes; do not hand-edit .botmux-dir.json.',
  'ai.dir_links.mr': 'After creating or finding this task\'s MR, run `botmux dir set mr <MR url>`. ',
  'ai.dir_links.meego': 'Once the Meego work item for this task is known, run `botmux dir set meego <work item url>`. ',
